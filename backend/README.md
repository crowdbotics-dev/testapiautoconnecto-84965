...
## Project Structure
    ...
    ├── testapiautoconnecto_84965  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_84965`
...
2. Clone this repo and `cd testapiautoconnecto_84965`
